...
<jsp:useBean id="sampleProductServiceImplProxyid" scope="session" class="com.soap.service.ProductServiceImplProxy" />
<%
...
case 10:
        gotMethod = true;
        com.soap.service.ProductServiceImpl getProductServiceImpl10mtemp = sampleProductServiceImplProxyid.getProductServiceImpl();
...
case 15:
        ...
        com.soap.model.Product getProduct15mtemp = sampleProductServiceImplProxyid.getProduct(id_1idTemp);
...
case 26:
        gotMethod = true;
        com.soap.model.Product[] getAllProducts26mtemp = sampleProductServiceImplProxyid.getAllProducts();
...
case 34:
        ...
        String qty_5id=  request.getParameter("qty41");
        int qty_5idTemp  = Integer.parseInt(qty_5id);
        String id_6id=  request.getParameter("id43");
        int id_6idTemp  = Integer.parseInt(id_6id);
        %>
        <jsp:useBean id="com1soap1model1Product_3id" scope="session" class="com.soap.model.Product" />
        <%
        com1soap1model1Product_3id.setName(name_4idTemp);
        com1soap1model1Product_3id.setQty(qty_5idTemp);
        com1soap1model1Product_3id.setId(id_6idTemp);
        boolean addProduct34mtemp = sampleProductServiceImplProxyid.addProduct(com1soap1model1Product_3id);
